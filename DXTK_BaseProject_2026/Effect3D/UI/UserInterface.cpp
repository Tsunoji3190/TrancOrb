...
/// インプットレイアウト
/// </summary>
const std::vector<D3D11_INPUT_ELEMENT_DESC> Effect3D::UserInterface::INPUT_LAYOUT =
{
...
/// コンストラクタ
/// </summary>
Effect3D::UserInterface::UserInterface()
	:m_pDR(nullptr)
	,m_windowHeight(0)
	,m_windowWidth(0)
	,m_textureHeight(0)
...
void Effect3D::UserInterface::Create(DX::DeviceResources* pDR
	, const wchar_t* path
...
void Effect3D::UserInterface::SetScale(DirectX::SimpleMath::Vector2 scale)
{
	m_scale = scale;
}
void Effect3D::UserInterface::SetPosition(DirectX::SimpleMath::Vector2 position)
{
	m_position = position;
}
/// <summary>
/// Shader作成部分だけ分離した関数
/// </summary>
void Effect3D::UserInterface::CreateShader()
{
	ID3D11Device1* device = m_pDR->GetD3DDevice();

	//	コンパイルされたシェーダファイルを読み込み
	kHorikawa::BinaryFile VSData = kHorikawa::BinaryFile::LoadFile(L"Resources/Shaders/UIVS.cso");
	kHorikawa::BinaryFile GSData = kHorikawa::BinaryFile::LoadFile(L"Resources/Shaders/UIGS.cso");
	kHorikawa::BinaryFile PSData = kHorikawa::BinaryFile::LoadFile(L"Resources/Shaders/UIPS.cso");
...
/// 描画関数
/// </summary>
void Effect3D::UserInterface::Render()
{
...
void Effect3D::UserInterface::SetWindowSize(const int& width, const int& height)
{
	m_windowWidth = width;
